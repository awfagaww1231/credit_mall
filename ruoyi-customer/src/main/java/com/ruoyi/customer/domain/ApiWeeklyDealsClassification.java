 ...
 * @date 2022-11-21
 */
public class ApiWeeklyDealsClassification extends BaseEntity
{
    ...
    /** 活动分类下的商品 */
    private List<ApiGoodsInfo> goodsInfos;

    public List<ApiGoodsInfo> getGoodsInfos() {
        return goodsInfos;
    }

    public void setGoodsInfos(List<ApiGoodsInfo> goodsInfos) {
