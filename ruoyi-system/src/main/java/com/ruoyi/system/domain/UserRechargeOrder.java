 ...
 * @date 2022-11-08
 */
public class UserRechargeOrder extends BaseEntity
{
    ...
    public void setRechargeMethod(Long rechargeMethod) 
    {
        this.rechargeMethod = rechargeMethod;
    }

    public Long getRechargeMethod() 
    {
